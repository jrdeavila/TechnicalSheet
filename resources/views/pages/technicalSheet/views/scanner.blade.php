        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="row justify-content-center mt-4">
                    ...
                    <div class="col-lg-4">
                        <x-adminlte-card title="Crear Ficha Tecnica de un Scanner" theme="primary" icon="fas fa-camera">
                            <form action="{{ route('technicalSheet.store') }}" method="POST">
                                @csrf
                                <x-adminlte-input name="name" label="Nombre del scanner"
                                    placeholder="Ingrese el nombre del scanner" />
                                <x-adminlte-input name="model" label="Modelo"
                                    placeholder="Ingrese el modelo del scanner" />
                                <x-adminlte-input name="serial_number" label="Numero de serie"
                                    placeholder="Ingrese el numero de serie del scanner" />
                        ...
                        <x-adminlte-card title="Responsable y ubicacion" theme="primary" icon="fas fa-user">
                            <form action="{{ route('technicalSheet.createDevice', 'scanner') }}" method="GET">
                                ...
                                @if (isset($users))
                                    <x-adminlte-button
                                        onclick="window.location = '{{ route('technicalSheet.createDevice', 'scanner') }}';"
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-8">
                                <x-adminlte-card title="Caracteristicas del Equipo" theme="secondary" icon="fas fa-cogs">
                                    <form @submit.prevent="addFeature">
                                        ...
                                        <x-adminlte-select x-on:change="setAnwsers" name="feature_id"
                            ...
                            <div x-show="newFeatures.length > 0" class="col-lg-12">
